              ...
              <tbody className="divide-y divide-surface-border">
                {agents.map((agent: Agent) => (
                  ...
                  >
                    <td className="px-4 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-neutral-500 max-w-[160px] text-truncate">
                            {agent.description}
                          </p>
                        </div>
                      </div>
                    ...
                    <td className="px-4 py-3.5">
                      <span className="rounded-full bg-white/5 px-2 py-0.5 text-xs text-neutral-400 font-mono">
                        {agent.model}
                      </span>
                    </td>
                    <td className="px-4 py-3.5">
